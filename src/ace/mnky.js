ace.define("ace/mode/mnky_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(acequire, exports, module) {
"use strict";
...
var IniHighlightRules = function() {
    this.$rules = {
        start: [{
            ...
            token: ['entity.name.function.mnky', 'entity.name.function.mnky', 'keyword.other.definition.mnky', 'entity.name.function.mnky', 'text', 'punctuation.separator.key-value.mnky'],
            regex: '(![^=]+)(\\()([^)]*)(\\))(\\s*)(=)?'
        },{
            ...
            token: ['punctuation.definition.entity.mnky', 'constant.section.group-title.mnky', 'punctuation.definition.entity.mnky'],
            regex: '^(\\[)(.*?)(\\])'
        }, {
...
ace.define("ace/mode/folding/mnky",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode"], function(acequire, exports, module) {
"use strict";
...
ace.define("ace/mode/mnky",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/mnky_highlight_rules","ace/mode/folding/mnky"], function(acequire, exports, module) {
"use strict";
