  ...
  toggleDebugMode() {
    if (this.debugMode) {
      if (this.scope.document.getElementById('demo-monkey-debug-helper-style') === null) {
        ...
        #demo-monkey-debug-box { position: fixed; bottom: 0px; right: 0px; border: 1px solid  rgb(168, 201, 135); background: rgb(168, 201, 135, 0.8); z-index: 99999; pointer-events: none; display: flex; flex-wrap: nowrap; justify-content: flex-end; border-radius: 6px 0px 0px 0px; }
