...
class SetDashboardBackground extends Command {
  ...
  constructor(dashboardId, value, location) {
    ...
    const [ newValue, isImage ] = SetDashboardBackground._getValue(value)
    this.value = newValue
  ...
  static _getValue(value) {
    ...
    if (SetDashboardBackground.colors[value.toLowerCase()]) {
      return [SetDashboardBackground.colors[value.toLowerCase()], false]
    }
